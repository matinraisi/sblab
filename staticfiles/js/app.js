	...
	countdownInit: function (countdownSelector, countdownTime) {
	  ...
	  if (eventCounter.length) {
		eventCounter.countdown(countdownTime, function (e) {
		  $(this).html(
			e.strftime(
			  "<div class='countdown-section'><div><div class='countdown-number day'>%D</div> <div class='countdown-unit'>روز</div> </div></div><div class='countdown-section'><div><div class='countdown-number hour'>%H</div> <div class='countdown-unit'>ساعت</div> </div></div><div class='countdown-section'><div><div class='countdown-number minute'>%M</div> <div class='countdown-unit'>دقیقه</div> </div></div><div class='countdown-section'><div><div class='countdown-number second'>%S</div> <div class='countdown-unit'>ثانیه</div> </div></div>"
			)
		  );
		});
	  }
